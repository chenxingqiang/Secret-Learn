...
"""
Usage Example for FLAffinityPropagation
...
from secretlearn.FL.clustering.affinity_propagation import FLAffinityPropagation


def main():
    """Main example function"""
    print("="*70)
    print(f" FLAffinityPropagation Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLAffinityPropagation...")
    ...
    model = FLAffinityPropagation(devices)
    model.fit(fed_X)
