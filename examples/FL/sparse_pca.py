...
"""
Usage Example for FLSparsePCA

This example demonstrates how to use the privacy-preserving SparsePca
...
from secretlearn.FL.decomposition.sparse_pca import FLSparsePCA


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSparsePCA Usage Example")
    print("="*70)
