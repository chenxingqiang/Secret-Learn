...
"""
Split Learning adapter for BernoulliRBM
...
class SLBernoulliRBM:
    """Split Learning BernoulliRBM (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLBernoulliRBM with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLBernoulliRBM training in PYU")
