...
class FLLabelEncoder:
    ...
    **kwargs
        Parameters passed to LabelEncoder
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLLabelEncoder with JAX acceleration")
        else:
            logging.info(f"[FL] FLLabelEncoder with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return LabelEncoder(warm_start=True, **kwargs)
