...
"""
Usage Example for SLSparseRandomProjection
...
from secretlearn.SL.random_projection.sparse_random_projection import SLSparseRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSparseRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLSparseRandomProjection...")
