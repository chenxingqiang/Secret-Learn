...
"""
Usage Example for FLQuantileTransformer
...
from secretlearn.FL.preprocessing.quantile_transformer import FLQuantileTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLQuantileTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLQuantileTransformer...")
    ...
    model = FLQuantileTransformer(devices)
    model.fit(fed_X)
