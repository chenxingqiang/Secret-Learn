...
"""
Federated Learning adapter for SelectKBest
...
class FLSelectKBest:
    """
    Federated Learning SelectKBest
    ...
    **kwargs
        Parameters passed to SelectKBest
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLSelectKBest with JAX acceleration")
        else:
            logging.info(f"[FL] FLSelectKBest with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return SelectKBest(warm_start=True, **kwargs)
