...
"""
Usage Example for FLFactorAnalysis
...
from secretlearn.FL.decomposition.factor_analysis import FLFactorAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" FLFactorAnalysis Usage Example")
    print("="*70)
    ...
    model = FLFactorAnalysis(devices)
    model.fit(fed_X)
