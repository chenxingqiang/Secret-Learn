...
"""
Usage Example for FLSplineTransformer
...
from secretlearn.FL.preprocessing.splinetransformer import FLSplineTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSplineTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSplineTransformer...")
    ...
    model = FLSplineTransformer(devices)
