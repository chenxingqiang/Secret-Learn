...
"""
Split Learning adapter for FunctionTransformer
...
class SLFunctionTransformer:
    """Split Learning FunctionTransformer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLFunctionTransformer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLFunctionTransformer training in PYU")
