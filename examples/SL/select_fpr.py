...
from secretlearn.SL.feature_selection.select_fpr import SLSelectFpr


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSelectFpr Usage Example")
    print("="*70)
