...
"""
Usage Example for FLTruncatedSVD

This example demonstrates how to use the privacy-preserving TruncatedSvd
...
from secretlearn.FL.decomposition.truncated_svd import FLTruncatedSVD


def main():
    """Main example function"""
    print("="*70)
    print(f" FLTruncatedSVD Usage Example")
    print("="*70)
