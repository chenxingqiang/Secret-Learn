...
class FLSelectFromModel:
    ...
    **kwargs
        Parameters passed to SelectFromModel
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLSelectFromModel with JAX acceleration")
        else:
            logging.info(f"[FL] FLSelectFromModel with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return SelectFromModel(warm_start=True, **kwargs)
