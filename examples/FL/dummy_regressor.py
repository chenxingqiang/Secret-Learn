...
"""
Usage Example for FLDummyRegressor
...
from secretlearn.FL.dummy.dummy_regressor import FLDummyRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLDummyRegressor Usage Example")
    print("="*70)
    ...
    model = FLDummyRegressor(devices)
