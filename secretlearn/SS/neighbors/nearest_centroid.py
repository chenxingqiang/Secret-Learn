...
"""
Federated Learning adapter for NearestCentroid
...
class SSNearestCentroid:
    """Federated Learning NearestCentroid"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: NearestCentroid(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSNearestCentroid with JAX acceleration")
