...
"""
Split Learning adapter for DictionaryLearning
...
class SLDictionaryLearning:
    """Split Learning DictionaryLearning (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLDictionaryLearning with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLDictionaryLearning training in PYU")
