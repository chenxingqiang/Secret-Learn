...
"""
Federated Learning adapter for LocalOutlierFactor
...
class SSLocalOutlierFactor:
    """Federated Learning LocalOutlierFactor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: LocalOutlierFactor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSLocalOutlierFactor with JAX acceleration")
