...
"""
Usage Example for FLSVC

This example demonstrates how to use the privacy-preserving Svc
...
from secretlearn.FL.svm.svc import FLSVC


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSVC Usage Example")
    print("="*70)
