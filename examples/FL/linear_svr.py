...
"""
Usage Example for FLLinearSVR

This example demonstrates how to use the privacy-preserving LinearSvr
...
from secretlearn.FL.svm.linear_svr import FLLinearSVR


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLinearSVR Usage Example")
    print("="*70)
