...
"""
Usage Example for FLKNeighborsRegressor
...
from secretlearn.FL.neighbors.k_neighbors_regressor import FLKNeighborsRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLKNeighborsRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLKNeighborsRegressor...")
    ...
    model = FLKNeighborsRegressor(devices)
