#!/usr/bin/env python3
"""Run all FL examples and log results"""
...
def main():
    ...
    examples_dir = base_dir / "examples" / "FL"
    log_dir = base_dir / "logs" / "examples" / "FL"
    ...
    print("="*70)
    print(f" Running All FL Examples: {len(example_files)} files")
    print("="*70)
    ...
    with open(summary_file, 'w', encoding='utf-8') as f:
        f.write(f"FL Examples Execution Summary\n")
