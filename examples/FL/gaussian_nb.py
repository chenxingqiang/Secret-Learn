...
"""
Usage Example for FLGaussianNB

This example demonstrates how to use the privacy-preserving GaussianNb
...
from secretlearn.FL.naive_bayes.gaussian_nb import FLGaussianNB


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGaussianNB Usage Example")
    print("="*70)
