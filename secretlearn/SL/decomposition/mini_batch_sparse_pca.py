...
"""
Split Learning adapter for MiniBatchSparsePCA
...
class SLMiniBatchSparsePCA:
    """Split Learning MiniBatchSparsePCA (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMiniBatchSparsePCA with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMiniBatchSparsePCA training in PYU")
