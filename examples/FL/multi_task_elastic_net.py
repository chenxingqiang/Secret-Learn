...
"""
Usage Example for FLMultiTaskElasticNet
...
from secretlearn.FL.linear_models.multi_task_elastic_net import FLMultiTaskElasticNet


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiTaskElasticNet Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMultiTaskElasticNet...")
