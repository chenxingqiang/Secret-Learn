...
"""
Usage Example for FLOneVsRestClassifier
...
from secretlearn.FL.multiclass.one_vs_rest_classifier import FLOneVsRestClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOneVsRestClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLOneVsRestClassifier...")
    ...
    model = FLOneVsRestClassifier(devices)
