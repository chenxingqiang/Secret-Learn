...
"""
Federated Learning adapter for PolynomialFeatures

PolynomialFeatures is an UNSUPERVISED preprocessing algorithm.
...
class FLPolynomialFeatures:
    """
    Federated Learning PolynomialFeatures
    ...
    **kwargs
        Parameters passed to PolynomialFeatures
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLPolynomialFeatures initialized with JAX acceleration")
        else:
            logging.info("[FL] FLPolynomialFeatures initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local PolynomialFeatures instance"""
        return PolynomialFeatures(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated PolynomialFeatures
        ...
        Returns
        -------
        self : FLPolynomialFeatures
            Fitted preprocessor
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated PolynomialFeatures fitting (unsupervised)")
        ...
        logging.info("[FL] Federated PolynomialFeatures fitting completed")
        return self
