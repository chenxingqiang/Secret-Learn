...
"""
Usage Example for SLTargetEncoder
...
from secretlearn.SL.preprocessing.target_encoder import SLTargetEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" SLTargetEncoder Usage Example")
    print("="*70)
