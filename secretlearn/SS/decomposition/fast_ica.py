...
"""
Federated Learning adapter for FastICA

FastICA is an UNSUPERVISED dimensionality reduction algorithm.
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLFastICA initialized with JAX acceleration")
        else:
            logging.info("[FL] FLFastICA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated FastICA dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated FastICA dimensionality reduction completed")
        return self
