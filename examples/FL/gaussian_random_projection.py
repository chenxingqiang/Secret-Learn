...
"""
Usage Example for FLGaussianRandomProjection
...
from secretlearn.FL.random_projection.gaussian_random_projection import FLGaussianRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGaussianRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGaussianRandomProjection...")
