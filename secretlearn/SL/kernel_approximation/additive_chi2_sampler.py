...
"""
Split Learning adapter for AdditiveChi2Sampler
...
class SLAdditiveChi2Sampler:
    """Split Learning AdditiveChi2Sampler (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLAdditiveChi2Sampler with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLAdditiveChi2Sampler training in PYU")
