...
"""
Split Learning adapter for GenericUnivariateSelect
...
class SLGenericUnivariateSelect:
    """Split Learning GenericUnivariateSelect (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLGenericUnivariateSelect with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLGenericUnivariateSelect training in PYU")
