...
"""
Usage Example for FLSequentialFeatureSelector
...
from secretlearn.FL.feature_selection.sequential_feature_selector import FLSequentialFeatureSelector


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSequentialFeatureSelector Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSequentialFeatureSelector...")
    ...
    model = FLSequentialFeatureSelector(devices)
