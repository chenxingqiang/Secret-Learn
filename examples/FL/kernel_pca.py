...
"""
Usage Example for FLKernelPCA

This example demonstrates how to use the privacy-preserving KernelPca
...
from secretlearn.FL.decomposition.kernel_pca import FLKernelPCA


def main():
    """Main example function"""
    print("="*70)
    print(f" FLKernelPCA Usage Example")
    print("="*70)
