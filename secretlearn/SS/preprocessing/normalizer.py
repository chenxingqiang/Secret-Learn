...
"""
Federated Learning adapter for Normalizer

Normalizer is an UNSUPERVISED preprocessing algorithm.
...
class SSNormalizer:
    ...
    **kwargs
        Parameters passed to Normalizer
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] SSNormalizer initialized with JAX acceleration")
        else:
            logging.info("[FL] SSNormalizer initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated Normalizer fitting (unsupervised)")
        ...
        logging.info("[FL] Federated Normalizer fitting completed")
        return self
