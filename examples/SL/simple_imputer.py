...
"""
Usage Example for SLSimpleImputer
...
from secretlearn.SL.impute.simple_imputer import SLSimpleImputer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSimpleImputer Usage Example")
    print("="*70)
