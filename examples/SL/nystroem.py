...
from secretlearn.SL.kernel_approximation.nystroem import SLNystroem


def main():
    """Main example function"""
    print("="*70)
    print(f" SLNystroem Usage Example")
    print("="*70)
