...
"""
Usage Example for SLDictVectorizer
...
from secretlearn.SL.feature_extraction.dict_vectorizer import SLDictVectorizer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLDictVectorizer Usage Example")
    print("="*70)
