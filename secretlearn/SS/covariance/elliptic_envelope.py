    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLEllipticEnvelope initialized with JAX acceleration")
        else:
            logging.info("[FL] FLEllipticEnvelope initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated EllipticEnvelope covariance estimation (unsupervised)")
