...
"""
Usage Example for FLMiniBatchSparsePCA
...
from secretlearn.FL.decomposition.mini_batch_sparse_pca import FLMiniBatchSparsePCA


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMiniBatchSparsePCA Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMiniBatchSparsePCA...")
    ...
    model = FLMiniBatchSparsePCA(devices)
