...
"""
Split Learning adapter for MultiLabelBinarizer
...
class SLMultiLabelBinarizer:
    """Split Learning MultiLabelBinarizer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMultiLabelBinarizer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMultiLabelBinarizer training in PYU")
