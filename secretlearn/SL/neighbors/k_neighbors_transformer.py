...
"""
Split Learning adapter for KNeighborsTransformer
...
class SLKNeighborsTransformer:
    """Split Learning KNeighborsTransformer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLKNeighborsTransformer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLKNeighborsTransformer training in PYU")
