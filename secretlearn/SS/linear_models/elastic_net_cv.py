...
"""
Federated Learning adapter for ElasticNetCV

ElasticNetCV is a SUPERVISED cross-validation model.
...
class FLElasticNetCV:
    """
    Federated Learning ElasticNetCV
    
    Cross-validation model with automatic hyperparameter tuning.
    
    In SS mode:
    - Each party performs local CV training
    - Best parameters are securely aggregated via SPU
    ...
    **kwargs
        Parameters passed to ElasticNetCV
    
    Examples
    --------
    >>> model = FLElasticNetCV(
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLElasticNetCV initialized with JAX acceleration")
        else:
            logging.info("[FL] FLElasticNetCV initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated ElasticNetCV training (CV)")
