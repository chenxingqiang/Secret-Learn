...
"""
Split Learning adapter for MultiTaskElasticNet
...
class SLMultiTaskElasticNet:
    """Split Learning MultiTaskElasticNet (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMultiTaskElasticNet with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMultiTaskElasticNet training in PYU")
