...
"""
Usage Example for FLIncrementalPCA
...
from secretlearn.FL.decomposition.incremental_pca import FLIncrementalPCA


def main():
    """Main example function"""
    print("="*70)
    print(f" FLIncrementalPCA Usage Example")
    print("="*70)
    ...
    model = FLIncrementalPCA(devices)
