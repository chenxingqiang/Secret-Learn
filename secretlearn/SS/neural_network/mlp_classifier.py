...
"""
Federated Learning adapter for MLPClassifier
...
class SSMLPClassifier:
    """Federated Learning MLPClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: MLPClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSMLPClassifier with JAX acceleration")
