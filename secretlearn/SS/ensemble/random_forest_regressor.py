...
"""
Federated Learning adapter for RandomForestRegressor
...
class SSRandomForestRegressor:
    """Federated Learning RandomForestRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: RandomForestRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSRandomforestregressor with JAX acceleration")
