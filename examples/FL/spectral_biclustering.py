...
"""
Usage Example for FLSpectralBiclustering
...
from secretlearn.FL.clustering.spectral_biclustering import FLSpectralBiclustering


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSpectralBiclustering Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSpectralBiclustering...")
