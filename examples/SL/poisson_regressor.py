...
"""
Usage Example for SLPoissonRegressor
...
from secretlearn.SL.linear_models.poisson_regressor import SLPoissonRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLPoissonRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLPoissonRegressor...")
