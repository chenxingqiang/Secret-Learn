...
"""
Federated Learning adapter for GaussianProcessRegressor
...
class SSGaussianProcessRegressor:
    """Federated Learning GaussianProcessRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: GaussianProcessRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSGaussianProcessRegressor with JAX acceleration")
