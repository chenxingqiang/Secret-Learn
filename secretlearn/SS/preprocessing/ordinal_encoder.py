...
"""
Federated Learning adapter for OrdinalEncoder
...
class FLOrdinalEncoder:
    """
    Federated Learning OrdinalEncoder
    ...
    **kwargs
        Parameters passed to OrdinalEncoder
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLOrdinalEncoder with JAX acceleration")
        else:
            logging.info(f"[FL] FLOrdinalEncoder with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return OrdinalEncoder(warm_start=True, **kwargs)
