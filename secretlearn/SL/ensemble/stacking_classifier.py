...
"""
Split Learning adapter for StackingClassifier
...
class SLStackingClassifier:
    """Split Learning StackingClassifier (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLStackingClassifier with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLStackingClassifier training in PYU")
