...
"""
Federated Learning adapter for KNeighborsRegressor
...
class SSKNeighborsRegressor:
    """Federated Learning KNeighborsRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: KNeighborsRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSKNeighborsRegressor with JAX acceleration")
