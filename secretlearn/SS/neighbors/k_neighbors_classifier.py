...
"""
Federated Learning adapter for KNeighborsClassifier
...
class SSKNeighborsClassifier:
    """Federated Learning KNeighborsClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: KNeighborsClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSKNeighborsClassifier with JAX acceleration")
