...
"""
Federated Learning adapter for PLSCanonical
...
class SSPLSCanonical:
    """Federated Learning PLSCanonical"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: PLSCanonical(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSPLSCanonical with JAX acceleration")
