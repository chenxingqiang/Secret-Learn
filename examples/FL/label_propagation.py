...
"""
Usage Example for FLLabelPropagation
...
from secretlearn.FL.semi_supervised.label_propagation import FLLabelPropagation


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLabelPropagation Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLLabelPropagation...")
    ...
    model = FLLabelPropagation(devices)
