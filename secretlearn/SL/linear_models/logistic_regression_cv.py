...
"""
Split Learning adapter for LogisticRegressionCV
...
class SLLogisticRegressionCV:
    """Split Learning LogisticRegressionCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLLogisticRegressionCV with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLLogisticRegressionCV training in PYU")
