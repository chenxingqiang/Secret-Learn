    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLRidgeCV initialized with JAX acceleration")
        else:
            logging.info("[FL] FLRidgeCV initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated RidgeCV training (CV)")
