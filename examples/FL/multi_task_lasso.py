...
"""
Usage Example for FLMultiTaskLasso
...
from secretlearn.FL.linear_models.multi_task_lasso import FLMultiTaskLasso


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiTaskLasso Usage Example")
    print("="*70)
