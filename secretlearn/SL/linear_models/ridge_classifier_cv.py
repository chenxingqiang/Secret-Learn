...
"""
Split Learning adapter for RidgeClassifierCV
...
class SLRidgeClassifierCV:
    """Split Learning RidgeClassifierCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLRidgeClassifierCV with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLRidgeClassifierCV training in PYU")
