...
"""
Split Learning adapter for NeighborhoodComponentsAnalysis
...
class SLNeighborhoodComponentsAnalysis:
    """Split Learning NeighborhoodComponentsAnalysis (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLNeighborhoodComponentsAnalysis with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLNeighborhoodComponentsAnalysis training in PYU")
