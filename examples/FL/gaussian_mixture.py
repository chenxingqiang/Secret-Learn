...
"""
Usage Example for FLGaussianMixture
...
from secretlearn.FL.mixture.gaussian_mixture import FLGaussianMixture


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGaussianMixture Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGaussianMixture...")
