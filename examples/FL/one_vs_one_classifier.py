...
"""
Usage Example for FLOneVsOneClassifier
...
from secretlearn.FL.multiclass.one_vs_one_classifier import FLOneVsOneClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOneVsOneClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLOneVsOneClassifier...")
    ...
    model = FLOneVsOneClassifier(devices)
