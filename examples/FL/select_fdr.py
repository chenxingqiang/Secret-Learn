...
from secretlearn.FL.feature_selection.select_fdr import FLSelectFdr


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectFdr Usage Example")
    print("="*70)
