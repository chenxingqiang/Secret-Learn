...
"""
Split Learning adapter for GraphicalLassoCV
...
class SLGraphicalLassoCV:
    """Split Learning GraphicalLassoCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLGraphicalLassoCV with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLGraphicalLassoCV training in PYU")
