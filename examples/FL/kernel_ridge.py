...
"""
Usage Example for FLKernelRidge

This example demonstrates how to use the privacy-preserving KernelRidge
...
from secretlearn.FL.kernel_ridge.kernel_ridge import FLKernelRidge


def main():
    """Main example function"""
    print("="*70)
    print(f" FLKernelRidge Usage Example")
    print("="*70)
