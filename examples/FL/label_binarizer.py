...
"""
Usage Example for FLLabelBinarizer
...
from secretlearn.FL.naive_bayes.label_binarizer import FLLabelBinarizer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLabelBinarizer Usage Example")
    print("="*70)
