...
"""
Usage Example for FLDictVectorizer
...
from secretlearn.FL.feature_extraction.dict_vectorizer import FLDictVectorizer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLDictVectorizer Usage Example")
    print("="*70)
