...
"""
Split Learning adapter for FeatureHasher
...
class SLFeatureHasher:
    """Split Learning FeatureHasher (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLFeatureHasher with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLFeatureHasher training in PYU")
