...
"""
Usage Example for FLTargetEncoder
...
from secretlearn.FL.preprocessing.target_encoder import FLTargetEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" FLTargetEncoder Usage Example")
    print("="*70)
