...
"""
Split Learning adapter for MultiTaskLasso
...
class SLMultiTaskLasso:
    """Split Learning MultiTaskLasso (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMultiTaskLasso with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMultiTaskLasso training in PYU")
