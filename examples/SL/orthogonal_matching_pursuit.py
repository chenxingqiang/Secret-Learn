...
"""
Usage Example for SLOrthogonalMatchingPursuit
...
from secretlearn.SL.linear_models.orthogonal_matching_pursuit import SLOrthogonalMatchingPursuit


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOrthogonalMatchingPursuit Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLOrthogonalMatchingPursuit...")
