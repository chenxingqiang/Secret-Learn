...
"""
Usage Example for FLMiniBatchKMeans
...
from secretlearn.FL.clustering.mini_batch_kmeans import FLMiniBatchKMeans


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMiniBatchKMeans Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMiniBatchKMeans...")
    ...
    model = FLMiniBatchKMeans(devices)
