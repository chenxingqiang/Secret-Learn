...
from secretlearn.SL.feature_selection.select_fdr import SLSelectFdr


def main():
    """Main example function"""
    print("="*70)
    print(f" SLSelectFdr Usage Example")
    print("="*70)
