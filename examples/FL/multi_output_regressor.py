...
"""
Usage Example for FLMultiOutputRegressor
...
from secretlearn.FL.multioutput.multi_output_regressor import FLMultiOutputRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiOutputRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMultiOutputRegressor...")
    ...
    model = FLMultiOutputRegressor(devices)
