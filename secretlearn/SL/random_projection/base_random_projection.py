...
"""
Split Learning adapter for BaseRandomProjection
...
class SLBaseRandomProjection:
    """Split Learning BaseRandomProjection (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLBaseRandomProjection with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLBaseRandomProjection training in PYU")
