...
"""
Usage Example for FLPowerTransformer
...
from secretlearn.FL.preprocessing.power_transformer import FLPowerTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLPowerTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLPowerTransformer...")
    ...
    model = FLPowerTransformer(devices)
    model.fit(fed_X)
