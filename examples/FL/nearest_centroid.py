...
"""
Usage Example for FLNearestCentroid
...
from secretlearn.FL.neighbors.nearest_centroid import FLNearestCentroid


def main():
    """Main example function"""
    print("="*70)
    print(f" FLNearestCentroid Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLNearestCentroid...")
    ...
    model = FLNearestCentroid(devices)
