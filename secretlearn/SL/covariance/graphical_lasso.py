...
"""
Split Learning adapter for GraphicalLasso
...
class SLGraphicalLasso:
    """Split Learning GraphicalLasso (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLGraphicalLasso with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLGraphicalLasso training in PYU")
