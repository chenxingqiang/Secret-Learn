...
"""
Split Learning adapter for OneHotEncoder
...
class SLOneHotEncoder:
    """Split Learning OneHotEncoder (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLOneHotEncoder with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLOneHotEncoder training in PYU")
