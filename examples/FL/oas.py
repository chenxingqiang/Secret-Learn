...
"""
Usage Example for FLOAS

This example demonstrates how to use the privacy-preserving Oas
...
from secretlearn.FL.covariance.oas import FLOAS


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOAS Usage Example")
    print("="*70)
