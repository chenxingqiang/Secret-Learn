...
"""
Split Learning adapter for SkewedChi2Sampler
...
class SLSkewedChi2Sampler:
    """Split Learning SkewedChi2Sampler (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSkewedChi2Sampler with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSkewedChi2Sampler training in PYU")
