...
class FLPowerTransformer:
    ...
    **kwargs
        Parameters passed to PowerTransformer
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLPowerTransformer initialized with JAX acceleration")
        else:
            logging.info("[FL] FLPowerTransformer initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLPowerTransformer
            Fitted preprocessor
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated PowerTransformer fitting (unsupervised)")
        ...
        logging.info("[FL] Federated PowerTransformer fitting completed")
        return self
