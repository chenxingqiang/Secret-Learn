...
"""
Federated Learning adapter for RandomForestClassifier
...
class SSRandomForestClassifier:
    """Federated Learning RandomForestClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: RandomForestClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSRandomforestclassifier with JAX acceleration")
