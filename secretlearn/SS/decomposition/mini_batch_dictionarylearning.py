...
"""
Federated Learning adapter for MiniBatchDictionaryLearning

MiniBatchDictionaryLearning is an UNSUPERVISED dimensionality reduction algorithm.
...
class FLMiniBatchDictionaryLearning:
    """
    Federated Learning MiniBatchDictionaryLearning
    ...
    **kwargs
        Parameters passed to MiniBatchDictionaryLearning
    ...
    >>> model = FLMiniBatchDictionaryLearning(
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMiniBatchDictionaryLearning initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMiniBatchDictionaryLearning initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local MiniBatchDictionaryLearning instance"""
        return MiniBatchDictionaryLearning(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated MiniBatchDictionaryLearning model
        ...
        Returns
        -------
        self : FLMiniBatchDictionaryLearning
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated MiniBatchDictionaryLearning dimensionality reduction (unsupervised)")
        ...
        if True:
            if device in x.partitions:
                ...
                logging.info(f"[FL] Party '{party_name}' completed local dimensionality reduction")
        
        self._is_fitted = True
        logging.info("[FL] Federated MiniBatchDictionaryLearning dimensionality reduction completed")
        return self
