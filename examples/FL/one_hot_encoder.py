...
"""
Usage Example for FLOneHotEncoder
...
from secretlearn.FL.preprocessing.one_hot_encoder import FLOneHotEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOneHotEncoder Usage Example")
    print("="*70)
