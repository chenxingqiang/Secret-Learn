...
"""
Federated Learning adapter for RFE
...
class FLRFE:
    ...
    **kwargs
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLRFE with JAX acceleration")
        else:
            logging.info(f"[FL] FLRFE with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return RFE(warm_start=True, **kwargs)
