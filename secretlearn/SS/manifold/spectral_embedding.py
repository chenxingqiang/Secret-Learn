...
"""
Federated Learning adapter for SpectralEmbedding

SpectralEmbedding is an UNSUPERVISED manifold learning algorithm.
...
class FLSpectralEmbedding:
    """
    Federated Learning SpectralEmbedding
    ...
    **kwargs
        Parameters passed to SpectralEmbedding
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLSpectralEmbedding initialized with JAX acceleration")
        else:
            logging.info("[FL] FLSpectralEmbedding initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local SpectralEmbedding instance"""
        return SpectralEmbedding(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated SpectralEmbedding model
        ...
        Returns
        -------
        self : FLSpectralEmbedding
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated SpectralEmbedding manifold learning (unsupervised)")
        ...
        logging.info("[FL] Federated SpectralEmbedding manifold learning completed")
        return self
