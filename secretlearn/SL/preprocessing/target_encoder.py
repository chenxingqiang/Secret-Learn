...
"""
Split Learning adapter for TargetEncoder
...
class SLTargetEncoder:
    """Split Learning TargetEncoder (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLTargetEncoder with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLTargetEncoder training in PYU")
