...
"""
Split Learning adapter for ExtraTreeRegressor
...
class SLExtraTreeRegressor:
    """Split Learning ExtraTreeRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLExtraTreeRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLExtraTreeRegressor training in PYU")
