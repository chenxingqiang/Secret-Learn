...
"""
Usage Example for SLFunctionTransformer
...
from secretlearn.SL.preprocessing.function_transformer import SLFunctionTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLFunctionTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLFunctionTransformer...")
