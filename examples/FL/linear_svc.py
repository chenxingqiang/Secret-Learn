...
"""
Usage Example for FLLinearSVC

This example demonstrates how to use the privacy-preserving LinearSvc
...
from secretlearn.FL.svm.linear_svc import FLLinearSVC


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLinearSVC Usage Example")
    print("="*70)
