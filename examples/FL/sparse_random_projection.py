...
"""
Usage Example for FLSparseRandomProjection
...
from secretlearn.FL.random_projection.sparse_random_projection import FLSparseRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSparseRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSparseRandomProjection...")
