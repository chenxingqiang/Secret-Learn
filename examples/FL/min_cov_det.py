...
"""
Usage Example for FLMinCovDet

This example demonstrates how to use the privacy-preserving MinCovDet
...
from secretlearn.FL.covariance.min_cov_det import FLMinCovDet


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMinCovDet Usage Example")
    print("="*70)
