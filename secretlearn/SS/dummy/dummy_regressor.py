...
"""
Federated Learning adapter for DummyRegressor
...
class SSDummyRegressor:
    """Federated Learning DummyRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: DummyRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSDummyregressor with JAX acceleration")
