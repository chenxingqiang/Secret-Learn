...
"""
Usage Example for FLHDBSCAN

This example demonstrates how to use the privacy-preserving Hdbscan
...
from secretlearn.FL.clustering.hdbscan import FLHDBSCAN


def main():
    """Main example function"""
    print("="*70)
    print(f" FLHDBSCAN Usage Example")
    print("="*70)
