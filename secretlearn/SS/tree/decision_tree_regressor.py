...
"""
Federated Learning adapter for DecisionTreeRegressor

DecisionTreeRegressor is a SUPERVISED decision tree algorithm.
...
class FLDecisionTreeRegressor:
    """
    Federated Learning DecisionTreeRegressor
    ...
    **kwargs
        Parameters passed to DecisionTreeRegressor
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLDecisionTreeRegressor initialized with JAX acceleration")
        else:
            logging.info("[FL] FLDecisionTreeRegressor initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local DecisionTreeRegressor instance"""
    ...
    def fit(
        ...
        """
        Fit the federated DecisionTreeRegressor model
        ...
        logging.info("[FL] Starting federated DecisionTreeRegressor training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated DecisionTreeRegressor training completed")
        return self
