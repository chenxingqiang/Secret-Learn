...
"""
Split Learning adapter for RadiusNeighborsTransformer
...
class SLRadiusNeighborsTransformer:
    """Split Learning RadiusNeighborsTransformer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLRadiusNeighborsTransformer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLRadiusNeighborsTransformer training in PYU")
