...
"""
Federated Learning adapter for BernoulliNB
...
class SSBernoulliNB:
    """Federated Learning BernoulliNB"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: BernoulliNB(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSBernoulliNB with JAX acceleration")
