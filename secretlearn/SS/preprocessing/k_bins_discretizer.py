...
"""
Federated Learning adapter for KBinsDiscretizer

KBinsDiscretizer is an UNSUPERVISED preprocessing algorithm.
...
class FLKBinsDiscretizer:
    """
    Federated Learning KBinsDiscretizer
    ...
    **kwargs
        Parameters passed to KBinsDiscretizer
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLKBinsDiscretizer initialized with JAX acceleration")
        else:
            logging.info("[FL] FLKBinsDiscretizer initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local KBinsDiscretizer instance"""
        return KBinsDiscretizer(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated KBinsDiscretizer
        ...
        Returns
        -------
        self : FLKBinsDiscretizer
            Fitted preprocessor
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated KBinsDiscretizer fitting (unsupervised)")
        ...
        logging.info("[FL] Federated KBinsDiscretizer fitting completed")
        return self
