...
"""
Split Learning adapter for TheilSenRegressor
...
class SLTheilSenRegressor:
    """Split Learning TheilSenRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLTheilSenRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLTheilSenRegressor training in PYU")
