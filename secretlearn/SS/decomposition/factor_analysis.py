...
class FLFactorAnalysis:
    ...
    **kwargs
        Parameters passed to FactorAnalysis
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLFactorAnalysis initialized with JAX acceleration")
        else:
            logging.info("[FL] FLFactorAnalysis initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLFactorAnalysis
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated FactorAnalysis dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated FactorAnalysis dimensionality reduction completed")
        return self
