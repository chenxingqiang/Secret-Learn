...
"""
Usage Example for FLNMF

This example demonstrates how to use the privacy-preserving Nmf
...
from secretlearn.FL.decomposition.nmf import FLNMF


def main():
    """Main example function"""
    print("="*70)
    print(f" FLNMF Usage Example")
    print("="*70)
