...
"""
Usage Example for FLLogisticRegression
...
from secretlearn.FL.linear_models.logistic_regression import FLLogisticRegression


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLogisticRegression Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLLogisticRegression...")
    ...
    model = FLLogisticRegression(devices)
