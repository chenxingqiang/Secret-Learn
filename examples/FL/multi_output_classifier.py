...
"""
Usage Example for FLMultiOutputClassifier
...
from secretlearn.FL.multioutput.multi_output_classifier import FLMultiOutputClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiOutputClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMultiOutputClassifier...")
    ...
    model = FLMultiOutputClassifier(devices)
