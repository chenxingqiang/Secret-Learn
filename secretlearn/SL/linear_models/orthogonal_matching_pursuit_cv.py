...
"""
Split Learning adapter for OrthogonalMatchingPursuitCV
...
class SLOrthogonalMatchingPursuitCV:
    """Split Learning OrthogonalMatchingPursuitCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLOrthogonalMatchingPursuitCV with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLOrthogonalMatchingPursuitCV training in PYU")
