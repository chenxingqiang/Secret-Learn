...
"""
Usage Example for FLAgglomerativeClustering
...
from secretlearn.FL.clustering.agglomerative_clustering import FLAgglomerativeClustering


def main():
    """Main example function"""
    print("="*70)
    print(f" FLAgglomerativeClustering Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLAgglomerativeClustering...")
    ...
    model = FLAgglomerativeClustering(devices)
    model.fit(fed_X)
