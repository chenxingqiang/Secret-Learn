...
"""
Usage Example for FLDecisionTreeClassifier
...
from secretlearn.FL.tree.decision_tree_classifier import FLDecisionTreeClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLDecisionTreeClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLDecisionTreeClassifier...")
    ...
    model = FLDecisionTreeClassifier(devices)
