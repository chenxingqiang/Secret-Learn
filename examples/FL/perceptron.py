...
"""
Usage Example for FLPerceptron
...
from secretlearn.FL.linear_models.perceptron import FLPerceptron


def main():
    """Main example function"""
    print("="*70)
    print(f" FLPerceptron Usage Example")
    print("="*70)
