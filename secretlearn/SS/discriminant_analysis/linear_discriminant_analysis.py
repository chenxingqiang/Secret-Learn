...
"""
Federated Learning adapter for LinearDiscriminantAnalysis
...
class SSLinearDiscriminantAnalysis:
    """Federated Learning LinearDiscriminantAnalysis"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: LinearDiscriminantAnalysis(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSLinearDiscriminantAnalysis with JAX acceleration")
