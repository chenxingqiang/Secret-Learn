...
from secretlearn.SS.feature_selection.select_fwe import SSSelectFwe


def main():
    """Main example function"""
    print("="*70)
    print(f" SSSelectFwe Usage Example")
    print("="*70)
