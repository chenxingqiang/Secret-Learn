...
"""
Federated Learning adapter for MeanShift

MeanShift is an UNSUPERVISED clustering algorithm.
...
class FLMeanShift:
    ...
    **kwargs
        Parameters passed to MeanShift
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMeanShift initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMeanShift initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated MeanShift clustering (unsupervised)")
