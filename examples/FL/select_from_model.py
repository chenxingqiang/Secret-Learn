...
"""
Usage Example for FLSelectFromModel
...
from secretlearn.FL.feature_selection.select_from_model import FLSelectFromModel


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectFromModel Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSelectFromModel...")
    ...
    model = FLSelectFromModel(devices)
