...
"""
Usage Example for FLTweedieRegressor
...
from secretlearn.FL.linear_models.tweedie_regressor import FLTweedieRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLTweedieRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLTweedieRegressor...")
