...
"""
Usage Example for FLMinMaxScaler
...
from secretlearn.FL.preprocessing.min_max_scaler import FLMinMaxScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMinMaxScaler Usage Example")
    print("="*70)
