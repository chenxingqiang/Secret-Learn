...
"""
Usage Example for FLMultiTaskLassoCV
...
from secretlearn.FL.linear_models.multi_task_lasso_cv import FLMultiTaskLassoCV


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultiTaskLassoCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLMultiTaskLassoCV...")
    ...
    model = FLMultiTaskLassoCV(devices)
