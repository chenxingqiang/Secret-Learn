...
"""
Usage Example for FLOneClassSVM

This example demonstrates how to use the privacy-preserving OneClassSvm
...
from secretlearn.FL.svm.one_class_svm import FLOneClassSVM


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOneClassSVM Usage Example")
    print("="*70)
