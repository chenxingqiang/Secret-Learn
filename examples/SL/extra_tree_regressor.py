...
"""
Usage Example for SLExtraTreeRegressor
...
from secretlearn.SL.tree.extra_tree_regressor import SLExtraTreeRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLExtraTreeRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLExtraTreeRegressor...")
