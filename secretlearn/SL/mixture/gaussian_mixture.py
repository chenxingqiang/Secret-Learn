...
"""
Split Learning adapter for GaussianMixture
...
class SLGaussianMixture:
    """Split Learning GaussianMixture (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLGaussianMixture with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLGaussianMixture training in PYU")
