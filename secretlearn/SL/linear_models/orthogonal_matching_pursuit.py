...
"""
Split Learning adapter for OrthogonalMatchingPursuit
...
class SLOrthogonalMatchingPursuit:
    """Split Learning OrthogonalMatchingPursuit (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLOrthogonalMatchingPursuit with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLOrthogonalMatchingPursuit training in PYU")
