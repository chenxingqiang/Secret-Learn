...
"""
Usage Example for FLSGDClassifier
...
from secretlearn.FL.linear_models.sgd_classifier import FLSGDClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSGDClassifier Usage Example")
    print("="*70)
