...
"""
Usage Example for FLGammaRegressor
...
from secretlearn.FL.linear_models.gamma_regressor import FLGammaRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGammaRegressor Usage Example")
    print("="*70)
