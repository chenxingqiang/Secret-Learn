...
"""
Federated Learning adapter for BaggingRegressor
...
class SSBaggingRegressor:
    """Federated Learning BaggingRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: BaggingRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSBaggingregressor with JAX acceleration")
