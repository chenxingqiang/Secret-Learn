...
from secretlearn.FL.feature_selection.select_fwe import FLSelectFwe


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectFwe Usage Example")
    print("="*70)
