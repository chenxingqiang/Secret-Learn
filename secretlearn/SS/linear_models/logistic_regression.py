...
"""
Federated Learning adapter for LogisticRegression

LogisticRegression is a SUPERVISED cross-validation model.
...
class FLLogisticRegression:
    """
    Federated Learning LogisticRegression
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLLogisticRegression initialized with JAX acceleration")
        else:
            logging.info("[FL] FLLogisticRegression initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated LogisticRegression training (CV)")
