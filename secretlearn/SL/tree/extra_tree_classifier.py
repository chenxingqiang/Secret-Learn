...
"""
Split Learning adapter for ExtraTreeClassifier
...
class SLExtraTreeClassifier:
    """Split Learning ExtraTreeClassifier (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLExtraTreeClassifier with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLExtraTreeClassifier training in PYU")
