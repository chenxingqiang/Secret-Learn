...
"""
Federated Learning adapter for AdaBoostRegressor
...
class SSAdaBoostRegressor:
    """Federated Learning AdaBoostRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: AdaBoostRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSAdaboostregressor with JAX acceleration")
