...
"""
Usage Example for FLOrthogonalMatchingPursuit
...
from secretlearn.FL.linear_models.orthogonal_matching_pursuit import FLOrthogonalMatchingPursuit


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOrthogonalMatchingPursuit Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLOrthogonalMatchingPursuit...")
