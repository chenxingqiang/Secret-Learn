...
"""
Usage Example for SLMultiTaskLasso
...
from secretlearn.SL.linear_models.multi_task_lasso import SLMultiTaskLasso


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiTaskLasso Usage Example")
    print("="*70)
