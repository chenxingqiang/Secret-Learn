...
"""
Federated Learning adapter for LabelSpreading
...
class SSLabelSpreading:
    """Federated Learning LabelSpreading"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: LabelSpreading(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSLabelSpreading with JAX acceleration")
