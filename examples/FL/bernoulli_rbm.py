...
"""
Usage Example for FLBernoulliRBM

This example demonstrates how to use the privacy-preserving BernoulliRbm
...
from secretlearn.FL.neural_network.bernoulli_rbm import FLBernoulliRBM


def main():
    """Main example function"""
    print("="*70)
    print(f" FLBernoulliRBM Usage Example")
    print("="*70)
