...
"""
Usage Example for FLGradientBoostingClassifier
...
def main():
    ...
    print("="*70)
    print(f" FLGradientBoostingClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGradientBoostingClassifier...")
    ...
    model = FLGradientBoostingClassifier(devices)
