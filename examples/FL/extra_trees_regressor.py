...
"""
Usage Example for FLExtraTreesRegressor
...
from secretlearn.FL.ensemble.extra_trees_regressor import FLExtraTreesRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLExtraTreesRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLExtraTreesRegressor...")
    ...
    model = FLExtraTreesRegressor(devices)
