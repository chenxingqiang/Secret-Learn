...
"""
Split Learning adapter for BayesianGaussianMixture
...
class SLBayesianGaussianMixture:
    """Split Learning BayesianGaussianMixture (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLBayesianGaussianMixture with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLBayesianGaussianMixture training in PYU")
