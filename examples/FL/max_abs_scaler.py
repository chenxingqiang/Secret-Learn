...
"""
Usage Example for FLMaxAbsScaler
...
from secretlearn.FL.preprocessing.max_abs_scaler import FLMaxAbsScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMaxAbsScaler Usage Example")
    print("="*70)
