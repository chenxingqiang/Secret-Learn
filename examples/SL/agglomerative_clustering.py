...
"""
Usage Example for SLAgglomerativeClustering
...
from secretlearn.SL.clustering.agglomerative_clustering import SLAgglomerativeClustering


def main():
    """Main example function"""
    print("="*70)
    print(f" SLAgglomerativeClustering Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLAgglomerativeClustering...")
    ...
    model = SLAgglomerativeClustering(devices)
