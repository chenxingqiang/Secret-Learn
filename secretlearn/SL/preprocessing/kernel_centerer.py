...
"""
Split Learning adapter for KernelCenterer
...
class SLKernelCenterer:
    """Split Learning KernelCenterer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLKernelCenterer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLKernelCenterer training in PYU")
