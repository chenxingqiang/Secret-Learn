...
class FLSGDClassifier:
    ...
    **kwargs
        Parameters passed to SGDClassifier
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLSGDClassifier initialized with JAX acceleration")
        else:
            logging.info("[FL] FLSGDClassifier initialized with sklearn")
    ...
    def fit(
        ...
        logging.info(f"[FL] Starting federated SGDClassifier training (iterative, {epochs} epochs)")
        ...
        logging.info("[FL] Federated SGDClassifier training completed")
        return self
