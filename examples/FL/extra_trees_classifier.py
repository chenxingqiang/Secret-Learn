...
"""
Usage Example for FLExtraTreesClassifier
...
from secretlearn.FL.ensemble.extra_trees_classifier import FLExtraTreesClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLExtraTreesClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLExtraTreesClassifier...")
    ...
    model = FLExtraTreesClassifier(devices)
