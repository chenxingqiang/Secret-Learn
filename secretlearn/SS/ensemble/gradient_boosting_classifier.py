...
"""
Federated Learning adapter for GradientBoostingClassifier
...
class SSGradientBoostingClassifier:
    """Federated Learning GradientBoostingClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: GradientBoostingClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSGradientboostingclassifier with JAX acceleration")
