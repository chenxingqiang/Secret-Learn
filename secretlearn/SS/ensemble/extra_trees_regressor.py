...
"""
Federated Learning adapter for ExtraTreesRegressor
...
class SSExtraTreesRegressor:
    """Federated Learning ExtraTreesRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: ExtraTreesRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSExtratreesregressor with JAX acceleration")
