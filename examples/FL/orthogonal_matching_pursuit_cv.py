...
"""
Usage Example for FLOrthogonalMatchingPursuitCV
...
from secretlearn.FL.linear_models.orthogonal_matching_pursuit_cv import FLOrthogonalMatchingPursuitCV


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOrthogonalMatchingPursuitCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLOrthogonalMatchingPursuitCV...")
    ...
    model = FLOrthogonalMatchingPursuitCV(devices)
