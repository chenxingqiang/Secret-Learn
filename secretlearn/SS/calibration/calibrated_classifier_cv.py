...
"""
Federated Learning adapter for CalibratedClassifierCV
...
class SSCalibratedClassifierCV:
    """Federated Learning CalibratedClassifierCV"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: CalibratedClassifierCV(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSCalibratedClassifierCV with JAX acceleration")
