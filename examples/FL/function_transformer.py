...
"""
Usage Example for FLFunctionTransformer
...
from secretlearn.FL.preprocessing.function_transformer import FLFunctionTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLFunctionTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLFunctionTransformer...")
