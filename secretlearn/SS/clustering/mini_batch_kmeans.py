...
class FLMiniBatchKMeans:
    ...
    **kwargs
        Parameters passed to MiniBatchKMeans
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMiniBatchKMeans initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMiniBatchKMeans initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLMiniBatchKMeans
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated MiniBatchKMeans clustering (unsupervised)")
        ...
        logging.info("[FL] Federated MiniBatchKMeans clustering completed")
        return self
