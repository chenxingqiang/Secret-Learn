...
"""
Usage Example for FLGradientBoostingRegressor
...
from secretlearn.FL.ensemble.gradient_boosting_regressor import FLGradientBoostingRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGradientBoostingRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGradientBoostingRegressor...")
    ...
    model = FLGradientBoostingRegressor(devices)
