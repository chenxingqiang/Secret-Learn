...
"""
Usage Example for FLBayesianGaussianMixture
...
from secretlearn.FL.mixture.bayesian_gaussian_mixture import FLBayesianGaussianMixture


def main():
    """Main example function"""
    print("="*70)
    print(f" FLBayesianGaussianMixture Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLBayesianGaussianMixture...")
