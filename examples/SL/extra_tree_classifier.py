...
"""
Usage Example for SLExtraTreeClassifier
...
from secretlearn.SL.tree.extra_tree_classifier import SLExtraTreeClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLExtraTreeClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLExtraTreeClassifier...")
