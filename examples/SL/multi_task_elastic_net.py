...
"""
Usage Example for SLMultiTaskElasticNet
...
from secretlearn.SL.linear_models.multi_task_elastic_net import SLMultiTaskElasticNet


def main():
    """Main example function"""
    print("="*70)
    print(f" SLMultiTaskElasticNet Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLMultiTaskElasticNet...")
