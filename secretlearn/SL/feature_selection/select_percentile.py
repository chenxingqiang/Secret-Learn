...
"""
Split Learning adapter for SelectPercentile
...
class SLSelectPercentile:
    """Split Learning SelectPercentile (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSelectPercentile with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSelectPercentile training in PYU")
