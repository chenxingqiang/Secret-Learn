...
"""
Split Learning adapter for NearestNeighbors
...
class SLNearestNeighbors:
    """Split Learning NearestNeighbors (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLNearestNeighbors with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLNearestNeighbors training in PYU")
