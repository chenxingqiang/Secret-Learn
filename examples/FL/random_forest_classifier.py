...
"""
Usage Example for FLRandomForestClassifier
...
def main():
    ...
    print("="*70)
    print(f" FLRandomForestClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLRandomForestClassifier...")
    ...
    model = FLRandomForestClassifier(devices)
