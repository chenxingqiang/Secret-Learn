...
"""
Split Learning adapter for SpectralCoclustering
...
class SLSpectralCoclustering:
    """Split Learning SpectralCoclustering (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSpectralCoclustering with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSpectralCoclustering training in PYU")
