...
"""
Federated Learning adapter for KernelRidge
...
class SSKernelRidge:
    """Federated Learning KernelRidge"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: KernelRidge(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSKernelRidge with JAX acceleration")
