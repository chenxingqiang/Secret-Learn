...
"""
Usage Example for FLSpectralEmbedding
...
from secretlearn.FL.manifold.spectral_embedding import FLSpectralEmbedding


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSpectralEmbedding Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSpectralEmbedding...")
    ...
    model = FLSpectralEmbedding(devices)
    model.fit(fed_X)
