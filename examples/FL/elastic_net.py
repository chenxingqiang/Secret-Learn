...
"""
Usage Example for FLElasticNet

This example demonstrates how to use the privacy-preserving ElasticNet
...
from secretlearn.FL.linear_models.elastic_net import FLElasticNet


def main():
    """Main example function"""
    print("="*70)
    print(f" FLElasticNet Usage Example")
    print("="*70)
