...
"""
Usage Example for FLQuantileRegressor
...
from secretlearn.FL.linear_models.quantile_regressor import FLQuantileRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLQuantileRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLQuantileRegressor...")
