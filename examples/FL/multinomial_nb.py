...
"""
Usage Example for FLMultinomialNB
...
from secretlearn.FL.naive_bayes.multinomial_nb import FLMultinomialNB


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMultinomialNB Usage Example")
    print("="*70)
