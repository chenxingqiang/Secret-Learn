...
class SSBinarizer:
    ...
    **kwargs
        Parameters passed to Binarizer
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] SSBinarizer initialized with JAX acceleration")
        else:
            logging.info("[FL] SSBinarizer initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated Binarizer fitting (unsupervised)")
        ...
        logging.info("[FL] Federated Binarizer fitting completed")
        return self
