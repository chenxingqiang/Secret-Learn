...
"""
Usage Example for SLDecisionTreeClassifier
...
from secretlearn.SL.tree.decision_tree_classifier import SLDecisionTreeClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" SLDecisionTreeClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLDecisionTreeClassifier...")
    ...
    model = SLDecisionTreeClassifier(devices)
