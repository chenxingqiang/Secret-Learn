...
"""
Usage Example for FLDecisionTreeRegressor
...
from secretlearn.FL.tree.decision_tree_regressor import FLDecisionTreeRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLDecisionTreeRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLDecisionTreeRegressor...")
    ...
    model = FLDecisionTreeRegressor(devices)
