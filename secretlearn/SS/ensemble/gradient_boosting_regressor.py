...
"""
Federated Learning adapter for GradientBoostingRegressor
...
class SSGradientBoostingRegressor:
    """Federated Learning GradientBoostingRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: GradientBoostingRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSGradientboostingregressor with JAX acceleration")
