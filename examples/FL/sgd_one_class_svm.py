...
"""
Usage Example for FLSGDOneClassSVM
...
from secretlearn.FL.linear_models.sgd_one_class_svm import FLSGDOneClassSVM


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSGDOneClassSVM Usage Example")
    print("="*70)
    ...
    model = FLSGDOneClassSVM(devices)
