...
"""
Federated Learning adapter for IncrementalPCA
...
class FLIncrementalPCA:
    """
    Federated Learning IncrementalPCA
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLIncrementalPCA initialized with JAX acceleration")
        else:
            logging.info("[FL] FLIncrementalPCA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated IncrementalPCA dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated IncrementalPCA dimensionality reduction completed")
        return self
