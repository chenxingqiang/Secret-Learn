...
"""
Federated Learning adapter for VotingClassifier
...
class SSVotingClassifier:
    """Federated Learning VotingClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: VotingClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSVotingclassifier with JAX acceleration")
