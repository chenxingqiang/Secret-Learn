...
"""
Federated Learning adapter for ExtraTreesClassifier
...
class SSExtraTreesClassifier:
    """Federated Learning ExtraTreesClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: ExtraTreesClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSExtratreesclassifier with JAX acceleration")
