...
from secretlearn.FL.feature_selection.select_fpr import FLSelectFpr


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectFpr Usage Example")
    print("="*70)
