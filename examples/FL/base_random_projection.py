...
"""
Usage Example for FLBaseRandomProjection
...
from secretlearn.FL.random_projection.base_random_projection import FLBaseRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" FLBaseRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLBaseRandomProjection...")
