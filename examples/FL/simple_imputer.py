...
"""
Usage Example for FLSimpleImputer
...
from secretlearn.FL.impute.simple_imputer import FLSimpleImputer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSimpleImputer Usage Example")
    print("="*70)
