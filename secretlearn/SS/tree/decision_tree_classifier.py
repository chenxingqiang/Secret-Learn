...
class FLDecisionTreeClassifier:
    ...
    **kwargs
        Parameters passed to DecisionTreeClassifier
    ...
    >>> 
    >>> model = FLDecisionTreeClassifier(
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLDecisionTreeClassifier initialized with JAX acceleration")
        else:
            logging.info("[FL] FLDecisionTreeClassifier initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local DecisionTreeClassifier instance"""
    ...
    def fit(
        ...
        logging.info("[FL] Starting federated DecisionTreeClassifier training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated DecisionTreeClassifier training completed")
        return self
