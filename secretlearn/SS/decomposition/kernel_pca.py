...
"""
Federated Learning adapter for KernelPCA

KernelPCA is an UNSUPERVISED dimensionality reduction algorithm.
...
class FLKernelPCA:
    ...
    **kwargs
        Parameters passed to KernelPCA
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLKernelPCA initialized with JAX acceleration")
        else:
            logging.info("[FL] FLKernelPCA initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated KernelPCA dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated KernelPCA dimensionality reduction completed")
        return self
