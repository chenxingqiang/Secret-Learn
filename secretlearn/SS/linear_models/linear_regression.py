...
"""
Federated Learning adapter for LinearRegression

LinearRegression is a SUPERVISED regression/classification algorithm.
...
class FLLinearRegression:
    """
    Federated Learning LinearRegression
    ...
    **kwargs
        Parameters passed to LinearRegression
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLLinearRegression initialized with JAX acceleration")
        else:
            logging.info("[FL] FLLinearRegression initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local LinearRegression instance"""
    ...
    def fit(
        ...
        """
        Fit the federated LinearRegression model
        ...
        logging.info("[FL] Starting federated LinearRegression training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated LinearRegression training completed")
        return self
