...
"""
Split Learning adapter for GaussianRandomProjection
...
class SLGaussianRandomProjection:
    """Split Learning GaussianRandomProjection (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLGaussianRandomProjection with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLGaussianRandomProjection training in PYU")
