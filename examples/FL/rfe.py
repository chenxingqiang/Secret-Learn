...
"""
Usage Example for FLRFE

This example demonstrates how to use the privacy-preserving Rfe
...
from secretlearn.FL.feature_selection.rfe import FLRFE


def main():
    """Main example function"""
    print("="*70)
    print(f" FLRFE Usage Example")
    print("="*70)
