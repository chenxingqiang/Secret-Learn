...
"""
Federated Learning adapter for HistGradientBoostingRegressor
...
class SSHistGradientBoostingRegressor:
    """Federated Learning HistGradientBoostingRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: HistGradientBoostingRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSHistgradientboostingregressor with JAX acceleration")
