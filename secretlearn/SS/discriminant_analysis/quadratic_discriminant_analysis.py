...
"""
Federated Learning adapter for Quadraticdiscriminantanalysis
...
class SSQuadraticdiscriminantanalysis:
    """Federated Learning Quadraticdiscriminantanalysis"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: Quadraticdiscriminantanalysis(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSQuadraticdiscriminantanalysis with JAX acceleration")
