...
"""
Federated Learning adapter for MultiOutputClassifier
...
class SSMultiOutputClassifier:
    """Federated Learning MultiOutputClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: MultiOutputClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSMultiOutputClassifier with JAX acceleration")
