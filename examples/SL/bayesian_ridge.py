...
"""
Usage Example for SLBayesianRidge
...
from secretlearn.SL.linear_models.bayesian_ridge import SLBayesianRidge


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBayesianRidge Usage Example")
    print("="*70)
