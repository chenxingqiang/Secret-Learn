...
"""
Usage Example for FLGraphicalLassoCV
...
from secretlearn.FL.covariance.graphical_lasso_cv import FLGraphicalLassoCV


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGraphicalLassoCV Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGraphicalLassoCV...")
    ...
    model = FLGraphicalLassoCV(devices)
