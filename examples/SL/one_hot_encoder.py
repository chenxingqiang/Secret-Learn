...
"""
Usage Example for SLOneHotEncoder
...
from secretlearn.SL.preprocessing.one_hot_encoder import SLOneHotEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" SLOneHotEncoder Usage Example")
    print("="*70)
