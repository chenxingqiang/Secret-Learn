...
"""
Split Learning adapter for MissingIndicator
...
class SLMissingIndicator:
    """Split Learning MissingIndicator (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMissingIndicator with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMissingIndicator training in PYU")
