...
"""
Federated Learning adapter for PCA
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLPCA initialized with JAX acceleration")
        else:
            logging.info("[FL] FLPCA initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local PCA instance"""
        return PCA(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated PCA model
        ...
        logging.info("[FL] Starting federated PCA dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated PCA dimensionality reduction completed")
        return self
