...
"""
Usage Example for SLKernelCenterer
...
from secretlearn.SL.preprocessing.kernel_centerer import SLKernelCenterer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLKernelCenterer Usage Example")
    print("="*70)
