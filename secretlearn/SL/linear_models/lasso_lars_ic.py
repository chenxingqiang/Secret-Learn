...
"""
Split Learning adapter for LassoLarsIC
...
class SLLassoLarsIC:
    """Split Learning LassoLarsIC (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLLassoLarsIC with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLLassoLarsIC training in PYU")
