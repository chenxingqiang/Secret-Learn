...
"""
Federated Learning adapter for RadiusNeighborsRegressor
...
class SSRadiusNeighborsRegressor:
    """Federated Learning RadiusNeighborsRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: RadiusNeighborsRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSRadiusNeighborsRegressor with JAX acceleration")
