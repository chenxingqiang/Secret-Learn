...
"""
Usage Example for FLExtraTreeClassifier
...
from secretlearn.FL.tree.extra_tree_classifier import FLExtraTreeClassifier


def main():
    """Main example function"""
    print("="*70)
    print(f" FLExtraTreeClassifier Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLExtraTreeClassifier...")
