...
"""
Usage Example for FLTheilSenRegressor
...
from secretlearn.FL.linear_models.theil_sen_regressor import FLTheilSenRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLTheilSenRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLTheilSenRegressor...")
