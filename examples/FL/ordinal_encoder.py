...
"""
Usage Example for FLOrdinalEncoder
...
from secretlearn.FL.preprocessing.ordinal_encoder import FLOrdinalEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" FLOrdinalEncoder Usage Example")
    print("="*70)
    ...
    model = FLOrdinalEncoder(devices)
