...
"""
Federated Learning adapter for ElasticNet

ElasticNet is a SUPERVISED regression/classification algorithm.
...
class FLElasticNet:
    ...
    **kwargs
        Parameters passed to ElasticNet
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLElasticNet initialized with JAX acceleration")
        else:
            logging.info("[FL] FLElasticNet initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local ElasticNet instance"""
    ...
    def fit(
        ...
        """
        Fit the federated ElasticNet model
        ...
        logging.info("[FL] Starting federated ElasticNet training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated ElasticNet training completed")
        return self
