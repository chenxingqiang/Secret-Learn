    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] SSRidge initialized with JAX acceleration")
        else:
            logging.info("[FL] SSRidge initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[FL] Starting federated Ridge training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated Ridge training completed")
        return self
