...
"""
Usage Example for FLTSNE

This example demonstrates how to use the privacy-preserving Tsne
...
from secretlearn.FL.manifold.tsne import FLTSNE


def main():
    """Main example function"""
    print("="*70)
    print(f" FLTSNE Usage Example")
    print("="*70)
