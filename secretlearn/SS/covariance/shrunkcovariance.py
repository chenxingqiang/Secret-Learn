...
class FLShrunkCovariance:
    ...
    **kwargs
        Parameters passed to ShrunkCovariance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLShrunkCovariance initialized with JAX acceleration")
        else:
            logging.info("[FL] FLShrunkCovariance initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLShrunkCovariance
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated ShrunkCovariance covariance estimation (unsupervised)")
        ...
        logging.info("[FL] Federated ShrunkCovariance covariance estimation completed")
        return self
