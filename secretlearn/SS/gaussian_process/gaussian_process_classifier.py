...
"""
Federated Learning adapter for GaussianProcessClassifier
...
class SSGaussianProcessClassifier:
    """Federated Learning GaussianProcessClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: GaussianProcessClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSGaussianProcessClassifier with JAX acceleration")
