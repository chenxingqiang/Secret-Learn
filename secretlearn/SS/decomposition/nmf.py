...
"""
Federated Learning adapter for NMF

NMF is an UNSUPERVISED dimensionality reduction algorithm.
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLNMF initialized with JAX acceleration")
        else:
            logging.info("[FL] FLNMF initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local NMF instance"""
        return NMF(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated NMF model
        ...
        logging.info("[FL] Starting federated NMF dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated NMF dimensionality reduction completed")
        return self
