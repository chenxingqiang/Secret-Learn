...
"""
Usage Example for FLPolynomialFeatures
...
from secretlearn.FL.preprocessing.polynomial_features import FLPolynomialFeatures


def main():
    """Main example function"""
    print("="*70)
    print(f" FLPolynomialFeatures Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLPolynomialFeatures...")
    ...
    model = FLPolynomialFeatures(devices)
    model.fit(fed_X)
