...
class FLHuberRegressor:
    ...
    **kwargs
        Parameters passed to HuberRegressor
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLHuberRegressor initialized with JAX acceleration")
        else:
            logging.info("[FL] FLHuberRegressor initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local HuberRegressor instance"""
    ...
    def fit(
        ...
        logging.info("[FL] Starting federated HuberRegressor training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated HuberRegressor training completed")
        return self
