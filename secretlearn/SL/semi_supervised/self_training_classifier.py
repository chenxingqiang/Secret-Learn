...
"""
Split Learning adapter for SelfTrainingClassifier
...
class SLSelfTrainingClassifier:
    """Split Learning SelfTrainingClassifier (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSelfTrainingClassifier with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSelfTrainingClassifier training in PYU")
