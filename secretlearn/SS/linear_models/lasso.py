...
"""
Federated Learning adapter for Lasso

Lasso is a SUPERVISED regression/classification algorithm.
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] SSLasso initialized with JAX acceleration")
        else:
            logging.info("[FL] SSLasso initialized with sklearn")
    ...
    def fit(
        ...
        logging.info("[FL] Starting federated Lasso training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated Lasso training completed")
        return self
