...
class FLSpectralClustering:
    ...
    **kwargs
        Parameters passed to SpectralClustering
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLSpectralClustering initialized with JAX acceleration")
        else:
            logging.info("[FL] FLSpectralClustering initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLSpectralClustering
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated SpectralClustering clustering (unsupervised)")
        ...
        logging.info("[FL] Federated SpectralClustering clustering completed")
        return self
