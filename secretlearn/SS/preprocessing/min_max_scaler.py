...
"""
Federated Learning adapter for MinMaxScaler
...
class FLMinMaxScaler:
    """
    Federated Learning MinMaxScaler
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMinMaxScaler initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMinMaxScaler initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated MinMaxScaler fitting (unsupervised)")
