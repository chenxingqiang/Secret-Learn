...
"""
Federated Learning adapter for TruncatedSVD

TruncatedSVD is an UNSUPERVISED dimensionality reduction algorithm.
...
class FLTruncatedSVD:
    """
    Federated Learning TruncatedSVD
    ...
    **kwargs
        Parameters passed to TruncatedSVD
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLTruncatedSVD initialized with JAX acceleration")
        else:
            logging.info("[FL] FLTruncatedSVD initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local TruncatedSVD instance"""
        return TruncatedSVD(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated TruncatedSVD model
        ...
        logging.info("[FL] Starting federated TruncatedSVD dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated TruncatedSVD dimensionality reduction completed")
        return self
