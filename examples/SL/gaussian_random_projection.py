...
"""
Usage Example for SLGaussianRandomProjection
...
from secretlearn.SL.random_projection.gaussian_random_projection import SLGaussianRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" SLGaussianRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLGaussianRandomProjection...")
