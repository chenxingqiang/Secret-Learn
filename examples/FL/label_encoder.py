...
"""
Usage Example for FLLabelEncoder

This example demonstrates how to use the privacy-preserving LabelEncoder
...
from secretlearn.FL.preprocessing.label_encoder import FLLabelEncoder


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLabelEncoder Usage Example")
    print("="*70)
