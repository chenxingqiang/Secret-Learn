...
"""
Usage Example for FLVarianceThreshold
...
from secretlearn.FL.feature_selection.variance_threshold import FLVarianceThreshold


def main():
    """Main example function"""
    print("="*70)
    print(f" FLVarianceThreshold Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLVarianceThreshold...")
    ...
    model = FLVarianceThreshold(devices)
    model.fit(fed_X)
