...
"""
Usage Example for FLQuadraticDiscriminantAnalysis
...
from secretlearn.FL.discriminant_analysis.quadratic_discriminant_analysis import FLQuadraticDiscriminantAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" FLQuadraticDiscriminantAnalysis Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLQuadraticDiscriminantAnalysis...")
    ...
    model = FLQuadraticDiscriminantAnalysis(devices)
