...
"""
Usage Example for FLSelectKBest
...
from secretlearn.FL.feature_selection.select_k_best import FLSelectKBest


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectKBest Usage Example")
    print("="*70)
