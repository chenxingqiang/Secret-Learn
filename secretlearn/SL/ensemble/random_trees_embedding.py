...
"""
Split Learning adapter for RandomTreesEmbedding
...
class SLRandomTreesEmbedding:
    """Split Learning RandomTreesEmbedding (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLRandomTreesEmbedding with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLRandomTreesEmbedding training in PYU")
