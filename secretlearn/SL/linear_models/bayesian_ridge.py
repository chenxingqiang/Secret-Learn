...
"""
Split Learning adapter for BayesianRidge
...
class SLBayesianRidge:
    """Split Learning BayesianRidge (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLBayesianRidge with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLBayesianRidge training in PYU")
