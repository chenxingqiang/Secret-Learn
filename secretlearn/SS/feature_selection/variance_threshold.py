...
class FLVarianceThreshold:
    """
    Federated Learning VarianceThreshold
    ...
    - Variances are securely aggregated via SPU encryption
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLVarianceThreshold initialized with JAX acceleration")
        else:
            logging.info("[FL] FLVarianceThreshold initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated VarianceThreshold fitting (unsupervised)")
        ...
        if True:
            if device in x.partitions:
                ...
                logging.info(f"[FL] Party '{party_name}' completed variance computation")
