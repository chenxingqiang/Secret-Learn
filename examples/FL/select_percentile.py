...
"""
Usage Example for FLSelectPercentile
...
from secretlearn.FL.feature_selection.select_percentile import FLSelectPercentile


def main():
    """Main example function"""
    print("="*70)
    print(f" FLSelectPercentile Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLSelectPercentile...")
