...
"""
Split Learning adapter for PolynomialCountSketch
...
class SLPolynomialCountSketch:
    """Split Learning PolynomialCountSketch (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLPolynomialCountSketch with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLPolynomialCountSketch training in PYU")
