...
"""
Split Learning adapter for MultiTaskLassoCV
...
class SLMultiTaskLassoCV:
    """Split Learning MultiTaskLassoCV (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLMultiTaskLassoCV with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLMultiTaskLassoCV training in PYU")
