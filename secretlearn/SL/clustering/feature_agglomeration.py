...
"""
Split Learning adapter for FeatureAgglomeration
...
class SLFeatureAgglomeration:
    """Split Learning FeatureAgglomeration (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLFeatureAgglomeration with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLFeatureAgglomeration training in PYU")
