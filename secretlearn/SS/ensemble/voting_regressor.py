...
"""
Federated Learning adapter for VotingRegressor
...
try:
    ...
    from secretflow.device.device.spu import SPU as SPUDevice
...
class SSVotingRegressor:
    """Federated Learning VotingRegressor"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: VotingRegressor(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSVotingregressor with JAX acceleration")
