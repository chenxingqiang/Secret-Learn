...
"""
Usage Example for FLARDRegression
...
from secretlearn.FL.linear_models.ard_regression import FLARDRegression


def main():
    """Main example function"""
    print("="*70)
    print(f" FLARDRegression Usage Example")
    print("="*70)
