...
"""
Federated Learning adapter for chi2
...
class FLchi2:
    ...
    **kwargs
    ...
    def __init__(self, spu : SPU, spu: SPU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[FL] FLchi2 with JAX acceleration")
        else:
            logging.info(f"[FL] FLchi2 with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        """Create local model instance"""
        return chi2(warm_start=True, **kwargs)
