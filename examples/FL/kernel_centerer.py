...
"""
Usage Example for FLKernelCenterer
...
from secretlearn.FL.preprocessing.kernel_centerer import FLKernelCenterer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLKernelCenterer Usage Example")
    print("="*70)
