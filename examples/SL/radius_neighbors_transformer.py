...
"""
Usage Example for SLRadiusNeighborsTransformer

This example demonstrates how to use the privacy-preserving RadiusNeighborsTransformer
in SecretFlow's split learning environment.
"""
...
from secretlearn.SL.neighbors.radius_neighbors_transformer import SLRadiusNeighborsTransformer


def main():
    """Main example function"""
    print("="*70)
    print(f" SLRadiusNeighborsTransformer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLRadiusNeighborsTransformer...")
