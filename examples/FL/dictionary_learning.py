...
"""
Usage Example for FLDictionaryLearning
...
from secretlearn.FL.decomposition.dictionary_learning import FLDictionaryLearning


def main():
    """Main example function"""
    print("="*70)
    print(f" FLDictionaryLearning Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLDictionaryLearning...")
