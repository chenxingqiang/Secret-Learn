...
"""
Federated Learning adapter for MinCovDet

MinCovDet is an UNSUPERVISED covariance estimation algorithm.
...
class FLMinCovDet:
    ...
    **kwargs
        Parameters passed to MinCovDet
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMinCovDet initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMinCovDet initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local MinCovDet instance"""
        return MinCovDet(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated MinCovDet model
        ...
        logging.info("[FL] Starting federated MinCovDet covariance estimation (unsupervised)")
        ...
        logging.info("[FL] Federated MinCovDet covariance estimation completed")
        return self
