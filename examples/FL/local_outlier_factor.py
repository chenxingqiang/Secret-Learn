...
"""
Usage Example for FLLocalOutlierFactor
...
from secretlearn.FL.neighbors.local_outlier_factor import FLLocalOutlierFactor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLocalOutlierFactor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLLocalOutlierFactor...")
    ...
    model = FLLocalOutlierFactor(devices)
