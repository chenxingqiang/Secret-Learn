...
"""
Usage Example for FLNormalizer
...
from secretlearn.FL.preprocessing.normalizer import FLNormalizer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLNormalizer Usage Example")
    print("="*70)
