...
"""
Usage Example for FLPoissonRegressor
...
from secretlearn.FL.linear_models.poisson_regressor import FLPoissonRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLPoissonRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLPoissonRegressor...")
