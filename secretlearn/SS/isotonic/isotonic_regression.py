...
"""
Federated Learning adapter for IsotonicRegression
...
class SSIsotonicRegression:
    """Federated Learning IsotonicRegression"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: IsotonicRegression(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSIsotonicRegression with JAX acceleration")
