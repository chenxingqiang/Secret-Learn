...
"""
Federated Learning adapter for MultinomialNB
...
class SSMultinomialNB:
    """Federated Learning MultinomialNB"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: MultinomialNB(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSMultinomialNB with JAX acceleration")
