    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] SSBirch initialized with JAX acceleration")
        else:
            logging.info("[FL] SSBirch initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated Birch clustering (unsupervised)")
        ...
        logging.info("[FL] Federated Birch clustering completed")
        return self
