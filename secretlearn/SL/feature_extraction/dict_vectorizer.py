...
"""
Split Learning adapter for DictVectorizer
...
class SLDictVectorizer:
    """Split Learning DictVectorizer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLDictVectorizer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLDictVectorizer training in PYU")
