...
class FLMiniBatchNMF:
    ...
    **kwargs
        Parameters passed to MiniBatchNMF
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMiniBatchNMF initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMiniBatchNMF initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated MiniBatchNMF dimensionality reduction (unsupervised)")
        ...
        logging.info("[FL] Federated MiniBatchNMF dimensionality reduction completed")
        return self
