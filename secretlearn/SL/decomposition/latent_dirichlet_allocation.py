...
"""
Split Learning adapter for LatentDirichletAllocation
...
class SLLatentDirichletAllocation:
    """Split Learning LatentDirichletAllocation (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLLatentDirichletAllocation with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLLatentDirichletAllocation training in PYU")
