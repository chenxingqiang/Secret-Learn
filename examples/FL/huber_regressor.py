...
"""
Usage Example for FLHuberRegressor
...
from secretlearn.FL.linear_models.huber_regressor import FLHuberRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLHuberRegressor Usage Example")
    print("="*70)
    ...
    model = FLHuberRegressor(devices)
