...
StandardScaler is an UNSUPERVISED preprocessing algorithm.
...
class FLStandardScaler:
    """
    Federated Learning StandardScaler
    ...
    **kwargs
        Parameters passed to StandardScaler
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLStandardScaler initialized with JAX acceleration")
        else:
            logging.info("[FL] FLStandardScaler initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        Returns
        -------
        self : FLStandardScaler
            Fitted preprocessor
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated StandardScaler fitting (unsupervised)")
        ...
        logging.info("[FL] Federated StandardScaler fitting completed")
        return self
