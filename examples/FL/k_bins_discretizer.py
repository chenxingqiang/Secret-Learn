...
"""
Usage Example for FLKBinsDiscretizer
...
from secretlearn.FL.preprocessing.k_bins_discretizer import FLKBinsDiscretizer


def main():
    """Main example function"""
    print("="*70)
    print(f" FLKBinsDiscretizer Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLKBinsDiscretizer...")
    ...
    model = FLKBinsDiscretizer(devices)
    model.fit(fed_X)
