...
"""
Federated Learning adapter for LabelPropagation
...
class SSLabelPropagation:
    """Federated Learning LabelPropagation"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: LabelPropagation(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSLabelPropagation with JAX acceleration")
