...
"""
Federated Learning adapter for OneVsRestClassifier
...
class SSOneVsRestClassifier:
    """Federated Learning OneVsRestClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: OneVsRestClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSOneVsRestClassifier with JAX acceleration")
