...
"""
Federated Learning adapter for AdaBoostClassifier
...
class SSAdaBoostClassifier:
    """Federated Learning AdaBoostClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: AdaBoostClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSAdaboostclassifier with JAX acceleration")
