...
"""
Split Learning adapter for TweedieRegressor
...
class SLTweedieRegressor:
    """Split Learning TweedieRegressor (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLTweedieRegressor with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLTweedieRegressor training in PYU")
