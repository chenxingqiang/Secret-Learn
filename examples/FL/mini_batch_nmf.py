...
"""
Usage Example for FLMiniBatchNMF
...
from secretlearn.FL.decomposition.mini_batch_nmf import FLMiniBatchNMF


def main():
    """Main example function"""
    print("="*70)
    print(f" FLMiniBatchNMF Usage Example")
    print("="*70)
