...
"""
Split Learning adapter for SimpleImputer
...
class SLSimpleImputer:
    """Split Learning SimpleImputer (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSimpleImputer with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSimpleImputer training in PYU")
