...
"""
Federated Learning adapter for RadiusNeighborsClassifier
...
class SSRadiusNeighborsClassifier:
    """Federated Learning RadiusNeighborsClassifier"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: RadiusNeighborsClassifier(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSRadiusNeighborsClassifier with JAX acceleration")
