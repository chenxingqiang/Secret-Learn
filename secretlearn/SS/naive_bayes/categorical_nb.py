...
"""
Federated Learning adapter for CategoricalNB
...
class SSCategoricalNB:
    """Federated Learning CategoricalNB"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: CategoricalNB(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSCategoricalNB with JAX acceleration")
