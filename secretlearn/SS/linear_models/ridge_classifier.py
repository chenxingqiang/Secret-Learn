...
class FLRidgeClassifier:
    ...
    **kwargs
        Parameters passed to RidgeClassifier
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLRidgeClassifier initialized with JAX acceleration")
        else:
            logging.info("[FL] FLRidgeClassifier initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local RidgeClassifier instance"""
    ...
    def fit(
        ...
        logging.info("[FL] Starting federated RidgeClassifier training (supervised, non-iterative)")
        ...
        logging.info("[FL] Federated RidgeClassifier training completed")
        return self
