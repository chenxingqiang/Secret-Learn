...
"""
Usage Example for SLDecisionTreeRegressor
...
from secretlearn.SL.tree.decision_tree_regressor import SLDecisionTreeRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" SLDecisionTreeRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLDecisionTreeRegressor...")
    ...
    model = SLDecisionTreeRegressor(devices)
