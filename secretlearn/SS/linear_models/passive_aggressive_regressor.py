...
class FLPassiveAggressiveRegressor:
    ...
    PassiveAggressiveRegressor is an iterative supervised algorithm that supports
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLPassiveAggressiveRegressor initialized with JAX acceleration")
        else:
            logging.info("[FL] FLPassiveAggressiveRegressor initialized with sklearn")
    
    @staticmethod
    def _create_local_model(**kwargs):
        return PassiveAggressiveRegressor(**kwargs)
    ...
    def fit(
        ...
        logging.info(f"[FL] Starting federated PassiveAggressiveRegressor training (iterative, {epochs} epochs)")
        ...
        logging.info("[FL] Federated PassiveAggressiveRegressor training completed")
        return self
