...
"""
Federated Learning adapter for EmpiricalCovariance

EmpiricalCovariance is an UNSUPERVISED covariance estimation algorithm.
...
class FLEmpiricalCovariance:
    """
    Federated Learning EmpiricalCovariance
    ...
    **kwargs
        Parameters passed to EmpiricalCovariance
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLEmpiricalCovariance initialized with JAX acceleration")
        else:
            logging.info("[FL] FLEmpiricalCovariance initialized with sklearn")
    ...
    def _create_local_model(**kwargs):
        """Create local EmpiricalCovariance instance"""
        return EmpiricalCovariance(**kwargs)
    
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        """
        Fit the federated EmpiricalCovariance model
        ...
        Returns
        -------
        self : FLEmpiricalCovariance
            Fitted model
        """
        if isinstance(x, VDataFrame):
            x = x.values
        
        logging.info("[FL] Starting federated EmpiricalCovariance covariance estimation (unsupervised)")
        ...
        logging.info("[FL] Federated EmpiricalCovariance covariance estimation completed")
        return self
