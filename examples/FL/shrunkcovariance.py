...
"""
Usage Example for FLShrunkCovariance
...
from secretlearn.FL.covariance.shrunkcovariance import FLShrunkCovariance


def main():
    """Main example function"""
    print("="*70)
    print(f" FLShrunkCovariance Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLShrunkCovariance...")
    ...
    model = FLShrunkCovariance(devices)
