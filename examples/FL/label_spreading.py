...
"""
Usage Example for FLLabelSpreading
...
from secretlearn.FL.semi_supervised.label_spreading import FLLabelSpreading


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLabelSpreading Usage Example")
    print("="*70)
    ...
    model = FLLabelSpreading(devices)
