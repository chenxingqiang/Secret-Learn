...
from secretlearn.FL.kernel_approximation.nystroem import FLNystroem


def main():
    """Main example function"""
    print("="*70)
    print(f" FLNystroem Usage Example")
    print("="*70)
