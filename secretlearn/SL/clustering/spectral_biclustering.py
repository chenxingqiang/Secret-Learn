...
"""
Split Learning adapter for SpectralBiclustering
...
class SLSpectralBiclustering:
    """Split Learning SpectralBiclustering (Supervised, Non-iterative)"""
    ...
    def __init__(self, spu: PYU, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSpectralBiclustering with JAX acceleration")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame], y: Union[FedNdarray, VDataFrame]):
        ...
        logging.info(f"[SL] SLSpectralBiclustering training in PYU")
