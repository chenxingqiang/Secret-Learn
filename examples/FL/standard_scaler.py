...
"""
Usage Example for FLStandardScaler
...
from secretlearn.FL.preprocessing.standard_scaler import FLStandardScaler


def main():
    """Main example function"""
    print("="*70)
    print(f" FLStandardScaler Usage Example")
    print("="*70)
    ...
    model = FLStandardScaler(devices)
    model.fit(fed_X)
