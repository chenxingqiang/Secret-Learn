...
"""
Usage Example for FLPLSCanonical

This example demonstrates how to use the privacy-preserving Plscanonical
...
from secretlearn.FL.cross_decomposition.plscanonical import FLPLSCanonical


def main():
    """Main example function"""
    print("="*70)
    print(f" FLPLSCanonical Usage Example")
    print("="*70)
