...
"""
Usage Example for FLBayesianRidge
...
from secretlearn.FL.linear_models.bayesian_ridge import FLBayesianRidge


def main():
    """Main example function"""
    print("="*70)
    print(f" FLBayesianRidge Usage Example")
    print("="*70)
