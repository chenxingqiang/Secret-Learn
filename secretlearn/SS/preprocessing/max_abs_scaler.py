...
class FLMaxAbsScaler:
    ...
    **kwargs
        Parameters passed to MaxAbsScaler
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[FL] FLMaxAbsScaler initialized with JAX acceleration")
        else:
            logging.info("[FL] FLMaxAbsScaler initialized with sklearn")
    ...
    def fit(self, x: Union[FedNdarray, VDataFrame]):
        ...
        logging.info("[FL] Starting federated MaxAbsScaler fitting (unsupervised)")
        ...
        logging.info("[FL] Federated MaxAbsScaler fitting completed")
        return self
