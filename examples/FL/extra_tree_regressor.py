...
"""
Usage Example for FLExtraTreeRegressor
...
from secretlearn.FL.tree.extra_tree_regressor import FLExtraTreeRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLExtraTreeRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLExtraTreeRegressor...")
