...
"""
Usage Example for FLGaussianProcessRegressor
...
from secretlearn.FL.gaussian_process.gaussian_process_regressor import FLGaussianProcessRegressor


def main():
    """Main example function"""
    print("="*70)
    print(f" FLGaussianProcessRegressor Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLGaussianProcessRegressor...")
    ...
    model = FLGaussianProcessRegressor(devices)
