...
Usage:
    Terminal 1: python adaboost_regressor.py --party bob
    Terminal 2: python adaboost_regressor.py --party alice
...
from secretlearn.SS.ensemble.adaboost_regressor import SSAdaBoostRegressor


def parse_args():
    parser = argparse.ArgumentParser(description='SS SSAdaBoostRegressor')
...
def main():
    ...
    print("="*70)
    print(f" SSAdaBoostRegressor - Party: {party_name.upper()}")
    print("="*70)
    print(f"
...
[{party_name}] [2/5] Preparing data...")    
    ...
    # Step 4: Train model
    print("\n[4/5] Training SSAdaBoostRegressor...")
