...
"""
Usage Example for SLBaseRandomProjection
...
from secretlearn.SL.random_projection.base_random_projection import SLBaseRandomProjection


def main():
    """Main example function"""
    print("="*70)
    print(f" SLBaseRandomProjection Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training SLBaseRandomProjection...")
