...
"""
Usage Example for FLLinearDiscriminantAnalysis
...
from secretlearn.FL.discriminant_analysis.linear_discriminant_analysis import FLLinearDiscriminantAnalysis


def main():
    """Main example function"""
    print("="*70)
    print(f" FLLinearDiscriminantAnalysis Usage Example")
    print("="*70)
    ...
    # Step 4: Train model
    print("\n[4/5] Training FLLinearDiscriminantAnalysis...")
    ...
    model = FLLinearDiscriminantAnalysis(devices)
