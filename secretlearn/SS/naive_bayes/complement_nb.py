...
"""
Federated Learning adapter for ComplementNB
...
class SSComplementNB:
    """Federated Learning ComplementNB"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: ComplementNB(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSComplementNB with JAX acceleration")
