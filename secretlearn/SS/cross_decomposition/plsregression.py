...
"""
Federated Learning adapter for PLSRegression
...
class SSPLSRegression:
    """Federated Learning PLSRegression"""
    ...
    def __init__(self, spu: Optional[SPU] = None, **kwargs):
        ...
        self.spu = spu
        self.spu = spu
        self.local_model = spu(lambda **kw: PLSRegression(**kw))(**kwargs)
        self._is_fitted = False
        if USING_XLEARN:
            logging.info(f"[FL] SSPLSRegression with JAX acceleration")
